...
static int overclock_percent = 0;
static bool skip_gameinfo_enable = true;
static bool samples_enable = true;
static int frameskip_level = 0;
static char sample_rate[8] = "48000";
static char screen_brightness[8] = "1.0";
...
static UINT8/*16*/ P3_state[KEY_TOTAL];
static UINT8/*16*/ P4_state[KEY_TOTAL];
static UINT8/*16*/ P5_state[KEY_TOTAL];
static UINT8/*16*/ P6_state[KEY_TOTAL];
static UINT8/*16*/ P7_state[KEY_TOTAL];
static UINT8/*16*/ P8_state[KEY_TOTAL];
static UINT16 retrokbd_state[RETROK_LAST];
static UINT16 retrokbd_state2[RETROK_LAST];
static INT32 retro_pad_axes[8][4];
...
//  RETRO
//============================================================
static const char core[] = "arcanetmame";
...
/*
   ...
   Add_Option("-noautoframeskip");
	...
	sprintf(frameskip, "%d", frameskip_level);
	Add_Option(frameskip);
	/* Libretro supplies joypad state through virtual MAME input devices. */
	Add_Option("-joystick");
   Add_Option("-samplerate");
   Add_Option(sample_rate);
	Add_Option("-brightness");
	Add_Option(screen_brightness);
	Add_Option("-contrast");
	Add_Option(screen_contrast);
	Add_Option("-gamma");
	Add_Option(screen_gamma);

	if (skip_gameinfo_enable)
